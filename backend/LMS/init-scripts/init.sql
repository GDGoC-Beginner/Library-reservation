...
-- 초기 데이터: 열람실
INSERT INTO rooms (room_name, total_seats) VALUES ('제1열람실', 54);
INSERT INTO rooms (room_name, total_seats) VALUES ('제2열람실', 54);
INSERT INTO rooms (room_name, total_seats) VALUES ('제3열람실', 54);

-- 초기 데이터: 좌석 (제1열람실 - 직접 INSERT)
INSERT INTO seats (room_id, seat_number, is_available)
SELECT 1, LEVEL, 'Y'
FROM DUAL
CONNECT BY LEVEL <= 54;
